...
<>
    ...
    <header className="">
    <div className='z-50 fixed w-full text-black flex justify-between pt-4 items-center'>


        <div className="ml-36 text-xl font-bold text-center uppercase">
            <Link to="/" className=" font-bold logo min-w-[33.33%]">
                    {shop.name}
            </Link>
        </div>

        <nav className="mr-20 grid grid-cols-2 ">

            <ul className="flex place-self-center text-center justify-around list-none font-nav gap-3 max-w-[40]">
